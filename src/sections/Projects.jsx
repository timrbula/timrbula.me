...
const Background = () => (
  <div>
    ...
    <Triangle color="primaryDark" height={['25vh', '40vh']} width={['75vw', '60vw']} invertX invertY />
...
function Project({ name, description, projectUrl, repositoryUrl, type, publishedDate, logo }) {
  return (
    <Card p={0}>
      <Flex css={{ height: '200px' }}>
        ...
        <ImageContainer>
          ...
          <ImageSubtitle bg="backgroundDark" invert="true" top-s="-200px" top="-227px">
            {publishedDate}
          </ImageSubtitle>
